 ...
 * Ici (dernier rendu), pour les tableaux IA, un Blackjack est représenté par le
 * score 22
 * et un dépassement de 21 points par le score 0 pour le croupier
 * et le joueur.
 * Pour le jeu de ce dernier rendu, le score est le nombre réel de points
 * obtenus par le croupier
 * ou le joueur : un Blackjack est représenté par le score 21 et l'attribut
 * hasBlackjack
 * égal à true, et un dépassement de 21 points par ce même score dépassant 21
 * points.
 */
...
public class BlackjackGame {
    ...
    /**
     * Action : Affiche l'état initial du tour (état du jeu des joueurs et carte
     * visible du croupier).
     */
     ...
     *
     * @param upCardMinValue Valeur de la carte visible du croupier pour la
     ...
     *
     * @return Le solde du dernier joueur traité (utile pour la simulation
     *         mono-joueur).
     */
    ...
    /**
     * Logique de test de l'IA : Calcule les statistiques de performance de la
     * stratégie.
     * Conditions d'arrêt : Faillite, Solde doublé, ou limite de 10 x le solde en
     * nombre de parties.
     *
